...
module.exports = async (client, message) => {
    ...
    .setDescription(`Aight I'm ${client.user.username} I'm a multi purpose bot my prefix is \`${config.Prefix}\` try \`${config.Prefix}help\` to get the list of all my commands.\n\n <:invitekirito:892662458118996018> [Add Me](${config.Invite}) | <:kiritojoin:892662820888535071> [Join Server](${config.Server}) | <:7901instagram:892658992919236620>[ Hangout](${config.Github})`)
    .setTimestamp()
